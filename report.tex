...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{./tree.jpeg}
...
\href{https://github.com/Sourav-pi/COP290-C-Submission.git}{GitHub Repository}
\href{https://youtu.be/Bey5RierQLc}{Video Link}
